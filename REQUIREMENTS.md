# aradhya paints — Frontend Website Requirements
...
aradhya paints is a health-food brand offering premium dry-fruit blends, seeds, and balanced nutrition products for Indian families. This phase delivers a **frontend-only** marketing and product-catalog website — no payment gateway, no backend, no user accounts.
...
### 2.1 Brand Name
**aradhya paints** — evokes *Ojas* (vitality/energy in Ayurveda) and *Nath* (lord/protector). Positioning: trustworthy daily nutrition for Indian households.
...
>
> aradhya paints का संकल्प है कि हर भारतीय परिवार तक शुद्ध, पौष्टिक और गुणवत्तापूर्ण आहार पहुँचे, क्योंकि स्वस्थ परिवारों से ही एक सशक्त और समृद्ध राष्ट्र का निर्माण होता है।
...
/                     → Home
/about                → About Us
/why-aradya-paints    → Why Aradhya Paints
...
| Section | Content |
|---|---|
| Our Story | Origin of Aradhya Paints, why premium painting services matter |
...
### 3.3 Why Aradhya Paints (`/why-aradya-paints`)
...
User lands on Home
  ...
  → WhatsApp opens with pre-filled message:
      "Hi, I'd like to order:
       • Aradhya Paints [Service Name] × [Qty] — ₹[Line Total]
       Name: [optional field]
...
"Hi, I have an enquiry about Aradhya Paints services."
```
...
|---|---|
| **Header** | Logo, nav links (Home, About, Why Aradhya Paints, Services), cart icon with badge, mobile hamburger |
...
| Domain | TBD — `aradhya-paints.com` or similar |
