...
export default function TermsPage() {
  ...
  return (
    <div className="py-12 lg:py-20 section-panel">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-[#48556a] text-sm leading-relaxed">
          <section>
            <h2 className="text-[#10233c] font-display text-xl mb-3">
              1. General
            </h2>
            <p>
              These Terms and Conditions govern your use of the {BRAND.domain}{" "}
              website and your engagement with {BRAND.legalName}{" "}
              (&quot;Aradhya Paints&quot;, &quot;we&quot;, &quot;us&quot;). By requesting
              a consultation or quote, you agree to these terms.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                We deliver <strong className="text-[#10233c]">{DELIVERY.coverage}</strong>.
              </li>
              <li>
                Orders confirmed before the cut-off time are eligible for{" "}
                <strong className="text-[#10233c]">{DELIVERY.dispatch}</strong>.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              Aradhya Paints services are delivered to the highest workmanship
              standards with clear site preparation and finishing guidance.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Aradhya Paints shall not be liable for any indirect, incidental, or
              consequential damages arising from the use of our services or
              website. Our liability is limited to the value of the service
              agreement.
            </p>
          </section>
